        ...
        http
            ...
            .exceptionHandling(exceptionHandling -> exceptionHandling
                .authenticationEntryPoint((request, response, exception) ->
                    writeSecurityError(objectMapper, request, response, HttpStatus.UNAUTHORIZED, "auth.unauthenticated", "Authentication is required"))
                .accessDeniedHandler((request, response, exception) ->
                    writeSecurityError(objectMapper, request, response, HttpStatus.FORBIDDEN, "auth.forbidden", "Access is forbidden"))
            )
            .securityContext(context -> context.securityContextRepository(securityContextRepository()))
            .addFilterAfter(new SecurityActorCaptureFilter(), SecurityContextHolderFilter.class)
